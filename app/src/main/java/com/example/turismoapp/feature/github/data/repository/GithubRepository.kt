...
import com.example.turismoapp.feature.github.domain.model.UrlPath
...
class GithubRepository: IGithubRepository {
    override fun findByNick(value: String): Result<UserModel> {
        return Result.success( UserModel(
            nickname = "calyr", pathUrl = UrlPath("https://avatars.githubusercontent.com/u/874321?v=4"), summary = "String"))
